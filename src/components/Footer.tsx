  ...
  return (
    <Box
      sx={{
        ...
        padding: { sm: '119px 0 95px', xs: '100px 0' },
      }}
    >
      <CommonContainer>
        <Typography variant="h3" fontSize={isSm ? 48 : 72} lineHeight={isSm ? '60px' : '86px'} color="#FFFFFF">
          Contact
        </Typography>
        <Box
          sx={{
            paddingRight: { xs: '30px', sm: '80px' },
          }}
        >
          <Box
            sx={{
          ...
          >
            <TextField
              sx={{ ...textStyle, paddingRight: isSm ? '30%' : 0 }}
              select
              fullWidth
          ...
          <Box mt="60px" mb="40px" display={'flex'} flexDirection={isSm ? 'row-reverse' : 'unset'}>
            <Button
              width={170}
              height={60}
              onClick={commit}
        ...
        <Box display={'flex'} justifyContent="space-between" flexWrap={'wrap'} alignItems={'center'}>
          <Box display={'flex'} gap={isSm ? '20px' : '60px'} alignItems={'center'}>
            <Typography
              variant="h4"
              color={'#fff'}
