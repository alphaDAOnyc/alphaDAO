...
export default function Footer() {
  ...
  return (
    ...
    >
      <CommonContainer>
        <Typography variant="h3" fontSize={72} lineHeight="86px" color="#FFFFFF">
          Contact
        </Typography>
        <Box
          sx={{
        ...
        <Box display={'flex'} justifyContent="right">
          <Box display={'flex'} gap="60px" alignItems={'center'}>
            <Typography variant="h4" color={'#fff'} fontSize={32} lineHeight="38px">
              galaxypolygon.com
            </Typography>
